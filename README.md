...
[![Download aitea.dmg](https://custom-icon-badges.demolab.com/badge/-Download-blue?style=for-the-badge&logo=download&logoColor=white "Download DMG")](https://teaxyz.github.io/teaBASE/download.html)

> Requires macOS ≥13.5

> [!WARNING]
> aitea is in *beta*, almost certainly there are edge cases we are not yet
...
aitea's dotfile sync keeps your dotfiles versioned, backed up to a private
...
> [!NOTE]
> Building aitea requires Xcode >=16, which requires macOS >=14.5.
...
with a `aitea:` prefix and filtering in “Console.app” or showing
